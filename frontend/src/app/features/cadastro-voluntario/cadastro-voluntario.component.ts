...
export class CadastroVoluntarioComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public form: FormGroup = this.fb.group(
    {
      nomeCompleto: ['', [Validators.required, Validators.pattern(/^[A-Za-zÀ-ÖØ-öø-ÿ\s]+$/)]],
  ...
  public maiorDeIdadeValidator(control: AbstractControl): ValidationErrors | null {

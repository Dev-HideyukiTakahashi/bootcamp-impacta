...
public class AtividadeFactory {
    ...
    public static Atividade createAtividade() {
        return new Atividade(
                1,
                "Aula de Informática",
                "Aulas de informática básica para idosos",
                PeriodoAtividade.TARDE,
                "4 horas",
                "Rua das Flores, 123",
                true,
    ...
    public static List<Atividade> createAtividadeList() {
        return List.of(
                new Atividade(1, "Aula de Informática", "Descrição 1", PeriodoAtividade.TARDE,
                        "4 horas", "Endereço 1", true, StatusAtividade.ANDAMENTO),
                new Atividade(2, "Oficina de Artes", "Descrição 2", PeriodoAtividade.MANHA,
                        "3 horas", "Endereço 2", false, StatusAtividade.ANDAMENTO)
        );
    }
}

...
class AtividadeServiceTest {
    ...
    void atualizarStatus_DeveAtualizarStatus_QuandoSucesso() {
        ...
        try (MockedStatic<AtividadeMapper> mockedMapper = mockStatic(AtividadeMapper.class)) {
            ...
            AtividadeStatusResponseDTO result = atividadeService.atualizarStatus(1, atividadeStatusRequestDTO);
    ...
    void cadastrar_DeveSalvarAtividadeComStatusAndamento_QuandoSucesso() {
        ...
        AtividadeResponseDTO result = atividadeService.cadastrar(atividadeRequestDTO);
    ...
    void atualizar_DeveAtualizarAtividade_QuandoSucesso() {
        ...
        AtividadeResponseDTO result = atividadeService.atualizar(1, atividadeRequestDTO);
    ...
    void atualizar_DeveManterCriadoEm_QuandoAtualizar() {
        ...
        atividadeRequestDTO.setCriadoEm(LocalDateTime.now()); // Tentativa de alterar a data
        AtividadeResponseDTO result = atividadeService.atualizar(1, atividadeRequestDTO);

...
public class OngMapper {
    ...
    // Atualiza telefone e endereço usando o DTO — substitui campos se não forem nulos
    ...
    // Atualiza somente os campos do endereço, ignorando valores nulos para não sobrescrever

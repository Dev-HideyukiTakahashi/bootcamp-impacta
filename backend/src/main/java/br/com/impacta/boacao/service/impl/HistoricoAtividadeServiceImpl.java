...
public class HistoricoAtividadeServiceImpl implements HistoricoAtividadeService {
     ...
     */
    public HistoricoAtividadeServiceImpl(HistoricoAtividadeRepository repo) {
        this.repo = repo;
    }
    ...
    public HistoricoAtividadeResponseDTO buscarHistorico(HistoricoAtividadeRequestDTO request) {
        ...
        // 1) Conta quantos registros de HistoricoAtividade têm status APROVADO para esta atividade.
        ...
        // 3) Transforma a lista de entidades HistoricoAtividade em DTOs específicos de voluntário:
        //    a) map(HistoricoAtividade::getVoluntario) -> pega a entidade Voluntario associada a cada histórico
